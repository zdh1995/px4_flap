 ...
 *
*/
#ifndef _GAZEBO_LEFT_LIFT_DRAG_PLUGIN_HH_
#define _GAZEBO_LEFT_LIFT_DRAG_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE left_liftdrag_plugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: left_liftdrag_plugin();
    ...
    protected: std::ofstream outputfile;
  };
}
#endif
